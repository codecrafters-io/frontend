  ...
  If we launch new challenges during your membership, you get access to those too. Visit <a href="https://app.codecrafters.io/catalog" target="_blank" class="underline" rel="noopener noreferrer">our catalog</a> to check each individual challenge in detail.
   `,
    ...
    },
    {
      ...
      answer: `We always have at least one challenge available for free. You can easily find them highlighted in <a href="https://app.codecrafters.io/catalog" target="_blank" class="underline" rel="noopener noreferrer">our catalog</a>.
    
    Additionally, you can explore the detailed breakdowns of all our challenges without signing up.

    You can also view the task descriptions for every challenge without hitting a paywall.`
    },
    {
    ...
    },
    {
      ...
      answer: `We understand the cost consideration today but investing in your technical skills is one of the highest ROI activities you can do. It has a direct impact on your earning potential.<br><br>
  
  
    We’ve spoken with hundreds of our paid users about their experience before CodeCrafters. They’d spend weeks window-shopping for project ideas, trying to piece together resources, getting lost in “tutorial hell”, and realizing too late that their plans missed key details. Instead of wasting weeks or sometimes months’ worth of time, our users prefer to start right away with CodeCrafters, pushing code, refining their skills, and following our proven, battle-tested guidance.<br><br>
  
  
    If you’re early in your career or still a student working with limited budgets, focusing on foundational skills might be more appropriate before investing in CodeCrafters, which is designed for those who already have a job and are ready to push their limits.<br><br>
    
  
      Many companies allow employees to expense CodeCrafters as part of their learning and development budget, yours might too. <a href="https://codecrafters.io/expense" target="_blank" class="underline" rel="noopener noreferrer">Read more about that here</a>.`
    },
  ];
