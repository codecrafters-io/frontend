...
export default class SelectLanguageStep extends Component<Signature> {
...
declare module '@glint/environment-ember-loose/registry' {
  export default interface Registry {
    'CoursePage::IntroductionStep::WelcomeCard::CreateRepositoryQuestionnaire::SelectLanguageStep': typeof SelectLanguageStep;
  }
}
