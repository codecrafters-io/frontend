...
export default class CourseIdeaCard extends Component<Signature> {
  ...
  get userHasVoted() {
    ...
    return this.authenticator.currentUser!.courseExtensionIdeaVotes.map((item) => item.courseExtensionIdea).includes(this.args.courseExtensionIdea);
  }
...
declare module '@glint/environment-ember-loose/registry' {
  export default interface Registry {
    'RoadmapPage::CourseExtensionIdeaCard': typeof CourseIdeaCard;
  }
}
