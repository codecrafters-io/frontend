...
export default class Pill extends Component<Signature> {
  get colorClasses() {
    return {
      'dark-gray': 'bg-gray-200 text-gray-700 ring-gray-600/20 dark:bg-gray-900 dark:text-gray-400 dark:ring-gray-400/20',
      blue: 'bg-blue-50 text-blue-700 ring-blue-600/20 dark:bg-blue-950 dark:text-blue-400 dark:ring-blue-400/20',
      gray: 'bg-gray-50 text-gray-700 ring-gray-600/20 dark:bg-gray-900 dark:text-gray-400 dark:ring-gray-400/20',
      ...
      white: 'bg-white text-gray-600 ring-gray-600/20 dark:bg-gray-900 dark:text-gray-400 dark:ring-gray-400/20',
