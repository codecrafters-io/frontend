  ...
  get HTML() {
    showdown.extension('formatted-github-links', {
      ...
      filter: (text, converter, options) => {
        ...
        const svgHtml = parse(`<svg viewBox="0 0 1024 1024" fill="currentColor" xmlns="http://www.w3.org/2000/svg" class="inline w-4 mx-1">
        ...
        linkElements.forEach((linkElement) => {
          if (linkElement.getAttribute('href').startsWith('https://github.com')) {
            linkElement.insertAdjacentHTML('afterbegin', svgHtml);
          }
        });
