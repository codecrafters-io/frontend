...
export default class TeamPageMembersTableRow extends Component<Signature> {
...
declare module '@glint/environment-ember-loose/registry' {
  export default interface Registry {
    'TeamPage::MembersTable::Row': typeof TeamPageMembersTableRow;
  }
}
