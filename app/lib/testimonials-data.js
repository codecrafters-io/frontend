const testimonials = {
  'charles-guo': {
    ...
    authorAvatarImage: '/assets/images/user-avatars/charles-guo.png',
  ...
  'raghav-dua': {
    ...
    authorAvatarImage: '/assets/images/user-avatars/raghav-dua.jpeg',
  ...
  'djordje-lukic': {
    ...
    authorAvatarImage: '/assets/images/user-avatars/djorde-lukic.jpeg',
  ...
  'rahul-tarak': {
    ...
    authorAvatarImage: '/assets/images/user-avatars/rahul-tarak.jpeg',
  ...
  'pranjal-paliwal': {
    ...
    authorAvatarImage: '/assets/images/user-avatars/pranjal-paliwal.jpeg',
  ...
  'kang-ming-tay': {
    ...
    authorAvatarImage: '/assets/images/user-avatars/kangming.jpeg',
  ...
  'ananthalakshmi-sankar': {
    ...
    authorAvatarImage: '/assets/images/user-avatars/ananthalakshmi-sankar.jpeg',
  ...
  'beyang-liu': {
    ...
    authorAvatarImage: '/assets/images/user-avatars/beyang-liu.jpeg',
  ...
  'akshata-mohan': {
    ...
    authorAvatarImage: '/assets/images/user-avatars/akshata-mohan.jpeg',
  ...
  'jonathan-lorimer': {
    ...
    authorAvatarImage: '/assets/images/user-avatars/jonathan.jpeg',
  ...
  'patrick-burris': {
    ...
    authorAvatarImage: '/assets/images/user-avatars/patrick-burris.jpeg',
