const testimonials = {
  ...
  'raghav-dua': {
    ...
    authorAvatarImage: '/assets/images/user-avatars/raghav-dua.jpg',
  ...
  'djordje-lukic': {
    ...
    authorAvatarImage: '/assets/images/user-avatars/djorde-lukic.jpg',
  ...
  'rahul-tarak': {
    ...
    authorAvatarImage: '/assets/images/user-avatars/rahul-tarak.jpg',
  ...
  'pranjal-paliwal': {
    ...
    authorAvatarImage: '/assets/images/user-avatars/pranjal-paliwal.jpg',
  ...
  'kang-ming-tay': {
    ...
    authorAvatarImage: '/assets/images/user-avatars/kangming.jpg',
  ...
  'ananthalakshmi-sankar': {
    ...
    authorAvatarImage: '/assets/images/user-avatars/ananthalakshmi-sankar.jpg',
  ...
  'beyang-liu': {
    ...
    authorAvatarImage: '/assets/images/user-avatars/beyang-liu.jpg',
  ...
  'akshata-mohan': {
    ...
    authorAvatarImage: '/assets/images/user-avatars/akshata-mohan.jpg',
  ...
  'jonathan-lorimer': {
    ...
    authorAvatarImage: '/assets/images/user-avatars/jonathan.jpg',
  ...
  'patrick-burris': {
    ...
    authorAvatarImage: '/assets/images/user-avatars/patrick-burris.jpg',
