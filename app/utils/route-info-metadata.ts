...
export default class RouteInfoMetadata {
  ...
  constructor({ colorScheme = RouteColorScheme.Light, beaconVisibility = HelpscoutBeaconVisibility.Show }: { colorScheme?: RouteColorScheme, beaconVisibility?: HelpscoutBeaconVisibility } = {}) {
