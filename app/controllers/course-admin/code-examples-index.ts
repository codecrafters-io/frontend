...
import type { ModelType } from 'codecrafters-frontend/routes/course-admin/code-examples-index';
...
export default class CodeExamplesIndexController extends Controller {
