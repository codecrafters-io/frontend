...
module('Unit | Utility | sync-repository-stage-list', function (hooks) {
  ...
  test('it exists', function (assert) {
    ...
    const firstExtensionActivation = this.server.create('course-extension-activation', {
    ...
    const secondExtensionActivation = this.server.create('course-extension-activation', {
