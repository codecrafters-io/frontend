...
module('Acceptance | pay-test', function (hooks) {
  ...
  skip('new user can wait for subscriptions to sync after successful checkout session', async function () {
    signIn(this.owner);
    testScenario(this.server);
  ...
  skip('subscriber can manage subscription', async function () {
