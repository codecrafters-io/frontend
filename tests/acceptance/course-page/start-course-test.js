...
module('Acceptance | course-page | start-course', function (hooks) {
  ...
  test('can auto select language coming from track page', async function (assert) {
    ...
    assert.strictEqual(
      coursePage.createRepositoryCard.expandedSectionTitle,
      'Pick your preferred language',
      'current section title is "Pick your preferred language"',
    );
  ...
  test('can start course', async function (assert) {
    ...
    assert.ok(
      apiRequestsVerifier.verify([
        ...
        '/api/v1/leaderboard-rank-calculations', // refresh leaderboard rank calculation (after language selection)
        '/api/v1/repositories', // refresh repositories (after language selection)
        '/api/v1/leaderboard-rank-calculations', // refresh leaderboard rank calculation (after language selection)
        '/api/v1/leaderboard-entries', // refresh leaderboard entries (after language selection)
        '/api/v1/leaderboard-entries', // refresh leaderboard entries (after language selection)
      ]),
