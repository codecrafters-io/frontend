...
module('Acceptance | affiliate-page | view-payouts', function (hooks) {
  ...
  test('can initiate payout', async function (assert) {
    ...
    assert.contains(affiliatePage.payoutHistoryItems[0].text, 'December 3rd, 2023', 'processing payout shows correct date');
    assert.contains(affiliatePage.payoutHistoryItems[1].text, 'December 3rd, 2023', 'completed payout shows correct date');
    assert.contains(affiliatePage.payoutHistoryItems[2].text, 'December 2nd, 2023', 'failed payout shows correct date');
