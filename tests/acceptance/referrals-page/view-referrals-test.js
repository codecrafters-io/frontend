...
module('Acceptance | partner-page | view-referrals', function (hooks) {
  ...
  test('users who are not affiliates are redirected to the affiliate program page', async function (assert) {
    testScenario(this.server);
    ...
    assert.strictEqual(windowMock.location.href, 'https://docs.codecrafters.io/community/partner-program');
  });
