...
module('Integration | Component | rive-animation', function (hooks) {
  ...
  for (let i = 0; i < 100; i++) {
    test(`it renders and initializes correctly (iteration ${i + 1})`, async function (assert) {
      await render(hbs`
    ...
    test(`it works with different animation files (iteration ${i + 1})`, async function (assert) {
      await render(hbs`
        <div class="w-[200px] h-[200px]">
