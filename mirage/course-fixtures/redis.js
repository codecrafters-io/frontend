export default {
  ...
  "stages": [
    ...
    },
    {
      ...
      "difficulty": "easy",
      "marketing_md": "In this stage, you'll add support for responding to the `ACL WHOAMI` command.\n"
    },
    {
      "slug": "gx8",
      "primary_extension_slug": "authentication",
      ...
      "difficulty": "easy",
      "marketing_md": "In this stage, you'll add support for responding to the `ACL GETUSER` command.\n"
    },
    {
      "slug": "ql6",
      "primary_extension_slug": "authentication",
      ...
      "difficulty": "easy",
      "marketing_md": "In this stage, you'll add support for responding to the `ACL GETUSER` command with the `nopass` flag set.\n"
    },
    {
      "slug": "pl7",
      "primary_extension_slug": "authentication",
      ...
      "difficulty": "easy",
      "marketing_md": "In this stage, you'll add support for responding to the `ACL GETUSER` command with the passwords property.\n"
    },
    {
      "slug": "uv9",
      "primary_extension_slug": "authentication",
      ...
      "difficulty": "medium",
      "marketing_md": "In this stage, you'll add support for setting the default user's password.\n"
    },
    {
      "slug": "hz3",
      "primary_extension_slug": "authentication",
      ...
      "difficulty": "medium",
      "marketing_md": "In this stage, you'll add support for responding to the `AUTH` command.\n"
    },
    {
      "slug": "nm2",
      "primary_extension_slug": "authentication",
      ...
      "difficulty": "medium",
      "marketing_md": "In this stage, you'll add support for enforcing authentication for the `default` user.\n"
    },
    {
      "slug": "ws7",
      "primary_extension_slug": "authentication",
      ...
      "difficulty": "medium",
      "marketing_md": "In this stage, you'll implement enforcing authentication using the `AUTH` command.\n"
    }
  ]
}
